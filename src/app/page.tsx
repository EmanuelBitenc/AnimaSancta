      ...
      <div className="sm:max-w-4xl bg-white p-4 sm:p-6 rounded-lg shadow-md text-gray-800">
        <div className="flex flex-col gap-4 sm:gap-10 text-sm sm:text-lg text-center mx-auto bg-amber-950/20 rounded-lg p-2 sm:p-5">
          ...
          <p>
            ...
            que irão te ajudar a fazer um exame de consciência mais tranquilo e
            profundo, preparando seu coração para uma confissão sincera e cheia
            de renovação.
          </p>
          <p>
            <span className="underline text-amber-950 font-bold">
            ...
            que você seleciona as perguntas, elas são adicionadas à sua
